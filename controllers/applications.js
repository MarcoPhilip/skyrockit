...
// Create new applications form GET /new
...
// Create new application submission handler POST /new
router.post('/', async (req, res) => {
    ...
    try {
        ...
        // Push req.body (the nex form data object) to the
